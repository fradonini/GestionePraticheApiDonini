...
builder.Services.AddDbContext<PraticheDB>();
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "GestionePratiche API",
        Description = "Manage your pratiche",
        Version = "v1"
    });
});
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "GestionePratiche API V1");
});
